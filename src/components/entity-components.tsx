// Contains reusable components for workflows,credentails,executions
    ...
    <div className="flex flex-row items-center justify-between gap-x-4 ">
        <div className="flex flex-col">
            ...
            { description
                && 
              (
              <p className="text-xs md:text-s text-muted-foreground">
                {description}
              </p>
              )
            }
        ...
        {!onNew && newButtonHref && (
            <Button 
                size="sm"
                asChild  // Button will become as it's first child (Link in this case)
            >
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button
                                            size="icon"
                                            variant="ghost"
                                            onClick={(e) => e.stopPropagation()}  // Prevent triggering the Link when clicking the button
                                        >
