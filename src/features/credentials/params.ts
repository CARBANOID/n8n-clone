...
export const credentialsParams = { // we define the parameters which are present in url 
    page : parseAsInteger
    ...
    .withOptions({ clearOnDefault : true}),  // so http://localhost:3000/credentials?page=1 will be http://localhost:3000/credentials
